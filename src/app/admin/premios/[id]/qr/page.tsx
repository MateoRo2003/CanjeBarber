...
// Deriva el dominio propio de la app a partir de la request/env, para que
// el QR impreso apunte siempre al dominio de la barbería (nunca a
// Supabase, que acá no interviene para nada de esto).
function urlBase() {
